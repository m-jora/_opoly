    ...
    def construct_spaces(self):
        ...
        for i in range(11):
            ...
            if i == 0: #0
                ...
                space = RailroadSpace(self.display,x,y,width,NORMAL_SPACE_HEIGHT,SPACE_BORDER_COLOR, (PropertyImages["Railroad"],0), DEFAULT_RAILROAD_COST, DEFAULT_RAILROAD_RENT)
                self.objects.append(space)
            elif i == 6: #6
                ...
                space = GoToJailSpace(self.display,x,y,width,NORMAL_SPACE_HEIGHT,SPACE_BORDER_COLOR, (CornerImages["InJail"],0))
                self.objects.append(space)
